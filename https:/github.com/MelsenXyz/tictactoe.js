...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split ('@')[0]} BOOYAH:v` : isTie ? 'Game berakhir' : `Menunggu @${room.game.currentTurn.split('@')[0]}`}
